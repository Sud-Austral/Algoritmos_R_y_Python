...
subtitle: "Región de Antofagasta."
...
shp_comunas_por_region = shp_comunas_chile %>% filter(Region == "Región de Antofagasta")
...
covid19_region = covid19[covid19$Region == "Antofagasta", ]
...
anim_save("AN_3_casos_activos.gif")
```
