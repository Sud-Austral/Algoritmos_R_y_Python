...
shp_comunas_por_region = shp_comunas_chile %>% filter(Region == "Región de Los Ríos")
...
covid19_region = covid19[covid19$Region == "Los Ríos", ]
...
anim_save("AR_13_casos_activos.gif")
```
