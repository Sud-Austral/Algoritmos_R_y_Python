...
shp_comunas_por_region = shp_comunas_chile %>% filter(Region == "Región de Coquimbo")
...
covid19_region = covid19[covid19$Region == "Coquimbo", ]
...
anim_save("CO_5_casos_activos.gif")
```
