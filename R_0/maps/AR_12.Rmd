...
shp_comunas_por_region = shp_comunas_chile %>% filter(Region == "Región de La Araucanía")
...
covid19_region = covid19[covid19$Region == "La Araucanía", ]
...
anim_save("AR_12_casos_activos.gif")
```
