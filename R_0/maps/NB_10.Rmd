...
shp_comunas_por_region = shp_comunas_chile %>% filter(Region == "Región de Ñuble")
...
covid19_region = covid19[covid19$Region == "Ñuble", ]
...
anim_save("NB_10_casos_activos.gif")
```
