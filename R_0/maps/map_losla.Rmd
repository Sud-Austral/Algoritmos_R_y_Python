---
title: "Propagación del Covid-19 por Comuna en la Región de los Lagos desde el inicio de la pandemia en Chile."
...
shp_comunas_ayp = shp_comunas_chile %>% filter(Region == "Región de Los Lagos")
...
covid19_ayp = covid19[covid19$Region == "Los Lagos", ]
