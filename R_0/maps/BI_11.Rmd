...
subtitle: "Región del Región del Biobío."
...
shp_comunas_por_region = shp_comunas_chile %>% filter(Region == "Región del Bío-Bío")
...
covid19_region = covid19[covid19$Region == "Biobío", ]
...
anim_save("BI_11_casos_activos.gif")
```
