...
shp_comunas_por_region = shp_comunas_chile %>% filter(Region == "Región de Atacama")
...
covid19_region = covid19[covid19$Region == "Atacama", ]
...
anim_save("AT_4_casos_activos.gif")
```
