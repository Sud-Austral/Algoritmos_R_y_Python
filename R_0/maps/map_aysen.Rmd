---
title: "Propagación del Covid-19 por Comuna en la Región de Aysén desde el inicio de la pandemia en Chile."
...
shp_comunas_ayp = shp_comunas_chile %>% filter(Region == "Región de Aysén del Gral.Ibañez del Campo")
...
covid19_ayp = covid19[covid19$Region == "Aysén", ]
...
g <- ggplot(data_ayp)+
    ...
    labs(subtitle = "Fecha de la pandemia en la Región de Aysén: {current_frame}")
    animate(g, fps = 3, width = 750, height = 450)
    anim_save("aysen_casos.gif")
```
