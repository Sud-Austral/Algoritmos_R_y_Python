...
subtitle: "Región del Libertador General Bernardo O'Higgins."
...
shp_comunas_por_region = shp_comunas_chile %>% filter(Region == "Región del Libertador Bernardo O'Higgins")
...
covid19_region = covid19[covid19$Region == "O'Higgins", ]
...
anim_save("OH_8_casos_activos.gif")
```
