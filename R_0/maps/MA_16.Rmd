...
subtitle: "Región de Magallanes y de la Antártica Chilena."
...
shp_comunas_por_region = shp_comunas_chile %>% filter(Region == "Región de Magallanes y Antártica Chilena")
...
covid19_region = covid19[covid19$Region == "Magallanes", ]
...
anim_save("MA_16_casos_activos.gif")
```
