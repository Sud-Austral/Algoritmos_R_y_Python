...
shp_comunas_por_region = shp_comunas_chile %>% filter(Region == "Región del Maule")
...
covid19_region = covid19[covid19$Region == "Maule", ]
...
anim_save("ML_9_casos_activos.gif")
```
