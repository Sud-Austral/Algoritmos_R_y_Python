...
shp_comunas_por_region = shp_comunas_chile %>% filter(Region == "Región de Los Lagos")
...
covid19_region = covid19[covid19$Region == "Los Lagos", ]
...
anim_save("LL_14_casos_activos.gif")
```
