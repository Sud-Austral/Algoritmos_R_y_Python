...
subtitle: "Región de Aysén del General Carlos Ibáñez del Campo."
...
shp_comunas_por_region = shp_comunas_chile %>% filter(Region == "Región de Aysén del Gral.Ibañez del Campo")
...
covid19_region = covid19[covid19$Region == "Aysén", ]
...
anim_save("AI_15_casos_activos.gif")
```
