...
shp_comunas_por_region = shp_comunas_chile %>% filter(Region == "Región de Tarapacá")
...
covid19_region = covid19[covid19$Region == "Tarapacá", ]
...
anim_save("TA_2_casos_activos.gif")
```
