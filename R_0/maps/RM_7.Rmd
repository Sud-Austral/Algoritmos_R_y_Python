...
shp_comunas_por_region = shp_comunas_chile %>% filter(Region == "Región Metropolitana de Santiago")
...
covid19_region = covid19[covid19$Region == "Metropolitana", ]
...
anim_save("RM_7_casos_activos.gif")
```
