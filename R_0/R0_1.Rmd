...
```{r}
        rainseriesforecasts <- HoltWinters(eee$R0_v, beta=FALSE, gamma=FALSE)
        rainseriesforecasts
...
pred=predict(rainseriesforecasts, 4, prediction.interval = TRUE)
pred

plot(rainseriesforecasts, pred)


adf.test(eee$R0_v, alternative = "stationary")

# skirtsseriesforecasts2 <- forecast.HoltWinters(skirtsseriesforecasts, h=5)
