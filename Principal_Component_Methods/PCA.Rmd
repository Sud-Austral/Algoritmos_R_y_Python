...
# para ller un pepositorio: tiene un error.
library(readr)
...
data <- read.csv("C:/Users/usuario/Documents/GitHub_Personal/Bases_de_Datos_DS/DMCS/dmcs_2019.csv",
  header = TRUE,
...
library("xlsx")
# robo_con_vio <- read.xlsx(delin.xlsx, 1) 
# robo_con_vio <- read_excel("output.xlsx")
