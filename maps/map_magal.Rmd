---
title: "Propagación del Covid-19 por Comuna en la Región de Magallanes desde el inicio de la pandemia en Chile."
...
shp_comunas_ayp = shp_comunas_chile %>% filter(Region == "Región de Magallanes y Antártica Chilena")
...
covid19_ayp = covid19[covid19$Region == "Magallanes", ]
...
g <- ggplot(data_ayp)+
    ...
    labs(subtitle = "Fecha de la pandemia en la Región de Magallanes: {current_frame}")
    animate(g, fps = 3, width = 750, height = 450)
    anim_save("magal_casos.gif")
```
