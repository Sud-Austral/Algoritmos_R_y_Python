---
title: "Propagación del Covid-19 por Comuna en la Región del Libertador General Bernardo O’Higgins desde el inicio de la pandemia en Chile."
...
shp_comunas_ayp = shp_comunas_chile %>% filter(Region == "Región del Libertador Bernardo O'Higgins")
...
covid19_ayp = covid19[covid19$Region == "O'Higgins", ]
...
g <- ggplot(data_ayp)+
    ...
    labs(subtitle = "Fecha de la pandemia en la Región del Libertador General Bernardo O’Higgins: {current_frame}")
    animate(g, fps = 3, width = 750, height = 450)
    anim_save("liber_casos.gif")
```
