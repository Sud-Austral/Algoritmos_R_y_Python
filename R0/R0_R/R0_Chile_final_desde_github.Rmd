...
Se corrige error cometido al no descontar de los susceptibles infectados y recuperados de forma permanente en cada t.
```{r uno}
library(knitr)
library(kableExtra)
library(janitor)
...
# Cálculo del R0 para Chile

```{r dos}
library(rio)

link ='https://github.com/Sud-Austral/Datos/blob/master/datacovidChile/CovidChileV2a.xlsx?raw=true'
data = rio::import(link, which = 'FINAL')
data_poblacion = rio::import(link, which = 'LOCALIZA CL')
head(data,10)
covid19 <- data
