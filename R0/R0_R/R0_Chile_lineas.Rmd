...
R0 <- read.csv("C:/Users/usuario/Desktop/GitHub-trabajo/Algoritmos_R_y_Python/R0/R0_R/R0.csv")
# R0


# le asignammos nombres a las columnas:
names = c("index", "comuna", "R0",  "fecha")
colnames(R0) = names
colnames(R0)
R0
# R0
...
zona_sur_austral <- R0[ which(
    ...
    (R0$comuna == 'Temuco')|
    (R0$comuna == 'Valdivia'))
     ##5 13 de junio desde el 15-04-2020
    & ((R0$fecha >= 43995))),]
 zona_sur_austral
...
labs(color = "Comunas") + ggtitle("Evolución diaria del Número Básico de Reproducción \n para las 5 Comunas principales de la Zona Norte Chico de Chile \n desde el 9 de Mayo al 10 de Agosto del 2020") + xlab("DÍA") + ylab("Número Básico de Reproducción") +
    theme(plot.title = element_text(size = 28, face = "bold", hjust = 0.5),
    axis.title.x = element_text(size=22, face="bold", angle=0, hjust=1),
    axis.title.y = element_text(size=22, face="bold"),
    legend.text=element_text(size=22)) +
...
labs(color = "Comunas") + ggtitle("Evolución diaria del Número Básico de Reproducción \n para las 5 Comunas principales de la Zona Central de Chile \n desde el 13 de junio al 10 de Agosto del 2020") + xlab("DÍA") + ylab("Número Básico de Reproducción") +
    theme(plot.title = element_text(size = 28, face = "bold", hjust = 0.5),
    axis.title.x = element_text(size=22, face="bold", angle=0, hjust=1),
    axis.title.y = element_text(size=22, face="bold"),
    legend.text=element_text(size=22)) +
